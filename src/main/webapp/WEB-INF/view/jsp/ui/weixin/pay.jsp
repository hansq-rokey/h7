	        ...
	        <div class="wrap">
	            <div class="pay-head">
	                <p>
	                    ...
	                    <span class="strong">微信支付</span>应付金额：<span class="money"><fmt:formatNumber value="${fee }" type="currency" maxFractionDigits="2" minFractionDigits="2" /></span>元
	 		   ...
	 		   success: function(obj){
	 			  if ( !checkCode( obj ) ) {
	 				window.clearInterval(timer);
 					 //跳页面
	 				var baseUrl = "http://4s.ibaixiong.com";
