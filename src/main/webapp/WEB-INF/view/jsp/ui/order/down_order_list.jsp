...
<head>
    ...
    <script type="text/javascript">
        function showPage(number){
        	var id = $("#id").val();
            window.location.href="/u/merchant/cityDetail.html?pageNo="+number+"&id="+id;
        }
    </script>
</head>
<body>
		              ...
		              <tbody>
		                <c:forEach items="${pageInfo.list }" var="item" varStatus="vs">
		                  <tr class="text-indent">
		                      ...
		                      <td  class="table_w17">
		                          <p><fmt:formatNumber value="${item.totalNum }" pattern="#" /></p>
		                      </td>
		                      <td class="table_w17">
		                           <span><fmt:formatNumber value="${item.shouldPayMoney }" pattern="#.##" /></span>
		                      </td>
		                      <td class="table_w17">
		                          <p>
		                              <c:choose>
