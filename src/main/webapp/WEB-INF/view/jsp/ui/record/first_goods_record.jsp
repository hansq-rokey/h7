...
<script type="text/javascript">
	function showPage(number) {
		var id = $("#id").val();
		window.location.href = "/u/firstGoodsRecord.html?pageNo=" + number+"&id="+id;
	}
</script>
</head>
<body>
					...
					<table class="table-responsive table_box">
						<thead>
							<tr>
								...
								<th class="t-c">订单号</th>
								<th class="t-c">改变金额</th>
								<th class="t-c">备注</th>
								<th class="t-c">修改形式</th>
								<th class="t-c">提货款余额</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${records }" var="record">
								<tr>
									...
									<td class="editor-color"><fmt:formatNumber
											value="${record.money }" type="currency"
									...
									<td><fmt:formatNumber type="currency"
											...
											value="${record.firstGoodsMoneyBalanceAfter }" /></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
